...
- Callouts: capital conserving flows, ROI-based churn, stochastic arrivals/lockups/payout lags, token supply + holding times.

## Section 2: Capital flows and invariants

**Visual 2 – Funding flows**
- Sankey: investor funds 100 → split to creator and treasury (for example 75/25 with funding_contribution_cost=100, treasury_funding_rate=0.25). Total capital conserved.

**Visual 3 – Total wealth invariant**
- Line chart of total wealth (flat until fees/inflation), cumulative fees minted, and total wealth minus cumulative fees (flat baseline).

## Section 3: Behavior and ROI

**Visual 4 – ROI-driven churn timing**
- Staggered drops driven by ROI and noise; investors can churn before creators/users when ROI diverges.
